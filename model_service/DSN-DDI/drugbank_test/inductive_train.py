...
# 关键修改：将所有执行代码放在 main 函数中
def main():
    global train_data, s1_data, s2_data  # 声明为全局变量以便其他函数使用
    ...
    model = models.MVN_DDI(n_atom_feats, n_atom_hid, kge_dim, rel_total,
